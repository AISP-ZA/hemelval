...
const styles = StyleSheet.create({
  ...
  coverMonth: { color: color.gold, fontSize: 12, fontFamily: 'GeistMono', letterSpacing: 1.5 },
  coverName: { color: color.ink, fontFamily: 'CormorantGaramond', fontSize: 30, fontWeight: '400', marginTop: space.xs, letterSpacing: -0.5 },
